...
//import me.bristermitten.pdm.result.LoadingResult;
...
//     * typically either block, or delay initialization to use a callback.
//     *
//     * @return a {@link CompletableFuture} that is completed when dependency loading finishes. The completed value, being Void, may be null.
//     * @since 0.0.1
//     */
//    @NotNull
//    public CompletableFuture<LoadingResult> loadAllDependencies()
//    {
